...
const Notes = () => {
  document.title = `${ProjectName} | Notes`;
  ...
  const getlist = (page?: any, AcessData?: any) => {
    ...
    WebService.getAPI({
      action: `/question-pagination-list`,
      body: obj,
    })
      .then((res: any) => {
        if (res && res.coloumns) {
            ...
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                {data.menueMoadule.is_edit == 1 &&
                  <DropdownItem
                    onClick={(e) => toggleModel("AddEditNotes", data.id)}>
                ...
                {data.menueMoadule.sel_action_button && data.menueMoadule.sel_action_button.length > 0 && data.menueMoadule.sel_action_button.map((res: any) => {
                  return (<>
                    ...
                    {
                      res == "View" && <DropdownItem>
                        <Link
                          className="text-body"
                          to={{pathname: `/admin/notesCriteria/${data.id}`,}}>
                          <i className="ri-team-line align-middle me-1"></i>View
                        </Link>
                      </DropdownItem>
                    }
                  </>)
  ...
  return (
    <React.Fragment>
                    ...
                    <div className="col-sm-auto ms-auto">
                      <div className="hstack gap-2 flex-wrap">
                        <button
                          ...
                          id="create-btn"
                          onClick={(e) => toggleModel("AddEditNotes")}>
      ...
      <AddEditNotes
        ...
        show={modelName === "AddEditNotes" ? true : false}
        onCloseClick={() => {
          setModelName("");
        }}
      />
