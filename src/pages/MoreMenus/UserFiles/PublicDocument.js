...
import AddPublicDocument from "./AddPublicDocument";

const PublicDocument = () => {

    document.title = `${ProjectName} | Public Document`;
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Public Document" pageTitle="Public Document" location={"/admin/menu"} />
                    <Row>
                        <Col lg={12}>
                            <Card id="leadsList">
                                        ...
                                        <div className="col-sm-auto ms-auto">
                                            <div className="hstack gap-2 flex-wrap">
                                                <button
                                                    ...
                                                    id="create-btn"
                                                    onClick={e => toggleModel('AddPublicDocument')}
                                                >
            ...
            <AddPublicDocument 
                show={modelName === 'AddPublicDocument' ? true : false}
