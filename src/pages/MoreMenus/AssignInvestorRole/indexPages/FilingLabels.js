...
import AddEditInvestorDashboardFilingLabels from "./AddEditInvestorDashboardFilingLabels";
...
const FilingLabels = () => {
                                ...
                                <li className="list-inline-item">
                                    <UncontrolledDropdown>
                                        ...
                                        <DropdownMenu className="dropdown-menu-end">
                                            <DropdownItem onClick={e => toggleModel('FilingLabels')}>
    ...
    return (
        <React.Fragment>
            ...
            <AddEditInvestorDashboardFilingLabels 
                show={modelName === 'FilingLabels' ? true : false}
