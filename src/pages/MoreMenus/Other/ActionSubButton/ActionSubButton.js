...
import AddEditActionSubButton from "./AddEditActionSubButton";
import { Link } from "react-router-dom";

const ActionSubButton = () => {

    document.title = `${ProjectName} | Action Sub Button `;
                                ...
                                <li className="list-inline-item">
                                    <UncontrolledDropdown>
                                        ...
                                        <DropdownMenu className="dropdown-menu-end">
                                            <DropdownItem onClick={e => toggleModel('AddEditActionSubButton', data)}>
                                            ...
                                            {/* <DropdownItem>
                                                <Link to="/admin/dealSubMenu" className="text-body">
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Action Sub Button" pageTitle="Action Sub Button" location={"/admin/menu"} />
                    <Row>
                        <Col lg={12}>
                            <Card id="leadsList">
                                        ...
                                        <div className="col-sm-auto ms-auto">
                                            <div className="hstack gap-2 flex-wrap">
                                                ...
                                                {/* <button
                                                    ...
                                                    id="create-btn"
                                                    onClick={e => toggleModel('AddEditActionSubButton')}
                                                >
            ...
            <AddEditActionSubButton
                data={data}
                setData={setData}
                show={modelName === 'AddEditActionSubButton' ? true : false}
