...
const SubCategory = () => {
  document.title = `${ProjectName} | Sub Category`;
          ...
          <li className="list-inline-item">
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                <DropdownItem
                  onClick={(e) => toggleModel("AddEditSubCategory", data.id)}>
  ...
  return (
    <React.Fragment>
                    ...
                    <div className="col-sm-auto ms-auto">
                      <div className="hstack gap-2 flex-wrap">
                        <button
                          ...
                          id="create-btn"
                          onClick={(e) =>
                            toggleModel("AddEditSubCategory", null, id)
                          }>
      ...
      <AddEditCategory
        ...
        show={modelName === "AddEditSubCategory" ? true : false}
        getlist={() => getlist(1)}
        onCloseClick={() => {
          setModelName("");
        }}
