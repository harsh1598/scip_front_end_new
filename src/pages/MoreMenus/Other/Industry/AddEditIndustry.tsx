...
const AddEditIndustry = (props: propData) => {
  ...
  return (
    <Offcanvas
      ...
      <OffcanvasHeader className="bg-light" toggle={props.onCloseClick}>
        {(props.formData && props.formData.industryId ? "Edit " : "Add ") +
          (props.parentId ? "Sub Industry" : formName)}
      </OffcanvasHeader>
      <OffcanvasBody className="my-offcanvas-body">
        <FormLayout
          formSlug="tbmstindustry"
          editUrl="/edit-industry"
          addUrl="/add-industry"
          id={props?.formData?.industryId}
