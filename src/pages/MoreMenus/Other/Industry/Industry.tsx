...
const Industry = () => {
  ...
  document.title = `${ProjectName} | Industry`;
                  ...
                  return (<>
                    ...
                    {res == "SubIndustry" && (
                      <DropdownItem className="text-truncate">
                        <Link className="text-body" to={{ pathname: `/admin/subindustry/${data.id}`, }}>
                      ...
                      <div className="col-sm-auto ms-auto">
                        <div className="hstack gap-2 flex-wrap">
                          <button
                            ...
                            id="create-btn"
                            onClick={(e) => toggleModel("AddEditIndustry")}>
