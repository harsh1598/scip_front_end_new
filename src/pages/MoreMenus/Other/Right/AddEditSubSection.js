...
const AddEditSubSection = ({ show, onCloseClick , formData }) => {
    ...
    return (
        ...
        >
            <OffcanvasHeader className="bg-light" toggle={onCloseClick}>
               {formData.id ? "Edit Option " : "Add Option "} 
            </OffcanvasHeader>
                    ...
                    <OffcanvasBody >
                        <div>
                            <Row>
                                <Col lg={12}>
                                    <div className="mb-2">
                                        <Label htmlFor="name-field" className="form-label">Option Title</Label>
                                        <Input
                                        name="name" id="customername-field"
                                        className="form-control" placeholder="Option Title" type="text"
