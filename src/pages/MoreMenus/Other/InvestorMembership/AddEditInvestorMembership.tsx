...
const AddEditInvestorMembership = (props: propData) => {
  ...
  return (
    <Offcanvas
      ...
      <OffcanvasBody className="my-offcanvas-body">
        <FormLayout
          formSlug="tblinvestormembershiptype"
          editUrl="/edit-membership"
          addUrl="/add-membership"
...
export default AddEditInvestorMembership;
