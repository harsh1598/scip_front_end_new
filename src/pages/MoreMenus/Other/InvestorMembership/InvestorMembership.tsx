...
import AddEditMembership from "./AddEditInvestorMembership";
import AddEditInvestorMembership from "./AddEditInvestorMembership";

const InvestorMembership = () => {
  document.title = `${ProjectName} | Investor Membership`;
  ...
  const getlist = (page?: any, AcessData?: any) => {
    ...
    WebService.getAPI({
      action: `/membership-pagination-list`,
      body: obj,
    })
      .then((res: any) => {
        if (res && res.coloumns) {
            ...
            <UncontrolledDropdown>
              ...
              {AcessData.is_edit == 1 && (
                <DropdownItem>
                  <a
                    className="text-body"
                    onClick={() => toggleModel("AddEditMembership", data.id)}>
  ...
  return (
    <>
      <AddEditInvestorMembership
        formData={formData.current}
        getlist={() => getModuleAcesslist(1)}
        show={modelName === "AddEditMembership" ? true : false}
        onCloseClick={() => {
          setModelName("");
        }}
      />
                    ...
                    <div className="col-sm-auto ms-auto">
                      <div className="d-flex hstack gap-2 flex-wrap">
                        <button
                          ...
                          onClick={() => toggleModel("AddEditMembership")}>
...
export default InvestorMembership;
