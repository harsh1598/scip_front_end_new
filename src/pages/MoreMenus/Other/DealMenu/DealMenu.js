...
import AddEditDealMenu from "./AddEditDealMenu";
import DealMenuFilter from "./DealMenuFilter";
import { Link } from "react-router-dom";

const DealMenu = () => {

    document.title = `${ProjectName} | Deal Menu `;
                                ...
                                <li className="list-inline-item">
                                    <UncontrolledDropdown>
                                        ...
                                        <DropdownMenu className="dropdown-menu-end">
                                            <DropdownItem onClick={e => toggleModel('AddEditDealMenu', data)}>
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Deal Menu" pageTitle="Deal Menu" location={"/admin/menu"} />
                    <Row>
                        <Col lg={12}>
                            <Card id="leadsList">
                                        ...
                                        <div className="col-sm-auto ms-auto">
                                            <div className="hstack gap-2 flex-wrap">
                                                ...
                                                {/* <button
                                                    ...
                                                    id="create-btn"
                                                    onClick={e => toggleModel('AddEditDealMenu')}
                                                >
            ...
            <AddEditDealMenu
                data={data}
                setData={setData}
                show={modelName === 'AddEditDealMenu' ? true : false}
                onCloseClick={() => setModelName("")}
            />
            <DealMenuFilter
                formData={formData}
                setFormData={setFormData}
                show={modelName === 'DealMenuFilter' ? true : false}
                onCloseClick={() => setModelName("")}
            />
            <SweetAlert
                custom
