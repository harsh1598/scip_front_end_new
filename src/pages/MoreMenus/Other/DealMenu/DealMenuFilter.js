...
const DealMenuFilter = ({ show, onCloseClick, formData, setFormData }) => {
                    ...
                    <OffcanvasBody >
                        <div>
                            <Row>
                                ...
                                <Col lg={12}>
                                    <div className="mb-3">
                                        <Label htmlFor="timezone" className="form-label">User Work Type </Label>
                                        <Select
                                            isClearable={true}
                                            // isMulti
                                            name="workType"
                                            value={formData.workType?formData.workType:[]}
                                            onChange={e=>handleChange("workType", e, 'multi')}
                                            options={CompanyStageList}
                                        />
                                    </div>
                                </Col>
