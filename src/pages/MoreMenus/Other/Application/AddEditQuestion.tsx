...
const AddEditApplicationQuestion = (props: propData) => {
    ...
    return (
        <Offcanvas
            ...
            <OffcanvasBody className="my-offcanvas-body">
                <FormLayout
                    formSlug="tblapplicationquestion"
                    editUrl="/edit-application-question"
                    addUrl="/add-application-question"
                    id={props?.formData?.question_id}
...
export default AddEditApplicationQuestion;
