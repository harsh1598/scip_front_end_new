  ...
  return (
    <Offcanvas
      ...
      <OffcanvasHeader className="bg-light" toggle={props.onCloseClick}>
        {/* {(props.formData && props.formData.sectionId ? "Edit Application Section " : "Add Application Section ") } */}
        {(props.formData && props.formData.sectionId ? "Edit " : "Add ") + formName}
      </OffcanvasHeader>
      <OffcanvasBody className="my-offcanvas-body">
        <FormLayout
          formSlug="tblapplicationsections"
          editUrl="/edit-application-section"
          addUrl="/add-application-section"
          id={props?.formData?.sectionId}
