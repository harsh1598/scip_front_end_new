...
const AppMenuFilter = ({ show, onCloseClick, formData, setFormData }) => {
                    ...
                    <OffcanvasBody >
                        <div>
                            <Row>
                                ...
                                <Col lg={12}>
                                    <div className="mb-3">
                                        <Label htmlFor="timezone" className="form-label">Screen Type </Label>
                                        <Select
                                            isClearable={true}
                                            // isMulti
                                            name="screenType"
                                            value={formData.screenType?formData.screenType:[]}
                                            onChange={e=>handleChange("screenType", e, 'multi')}
                                            options={CompanyStageList}
                                        />
                                    </div>
                                </Col>
