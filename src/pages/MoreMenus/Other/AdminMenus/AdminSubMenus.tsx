...
const AdminSubMenus = () => {
    document.title = `${ProjectName} | Sub Menus`;
    ...
    const getlist = (page?: any) => {
        ...
        WebService.getAPI({
            action: `/submenus-pagination-list`,
            body: obj,
        })
            .then((res: any) => {
                if (res && res.coloumns) {
                    ...
                    for (var i in res.list) {
                        ...
                        for (var j in arr) {
                            if (arr[j].title == "Sr No.") {
                                ...
                                columns.push({
                                    value: dateColumns({
                                        updated_date: moment(res.list[i].updated_date).format("DD-MM-YYYY HH:mm a")
                                    }),
                                });
