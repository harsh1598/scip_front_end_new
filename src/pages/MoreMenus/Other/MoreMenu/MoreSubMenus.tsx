...
const MoreSubMenus = () => {
    document.title = `${ProjectName} | More Sub Menus`;
    ...
    const getlist = (page?: any, AcessData?: any) => {
        ...
        WebService.getAPI({
            action: `/sub-more-menu-pagination-list`,
            body: obj,
        })
            .then((res: any) => {
                if (res && res.coloumns) {
                ...
                if (res && res.list) {
                    ...
                    for (var i in res.list) {
                        ...
                        for (var j in arr) {
                            ...
                            } else if (arr[j].db_column == "menuId") {
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb
                        // title="Sub Menus"
                        title={"Manage More Sub Menus  : " + `${name}` + ""}
                        pageTitle="More Sub Menus "
                        location={"/admin/menu"}
                    />
                    <Row>
                        <Col lg={12}>
