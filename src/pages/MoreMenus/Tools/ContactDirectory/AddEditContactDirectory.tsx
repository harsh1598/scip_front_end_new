...
const AddEditContactDirectory = (props: propData) => {
  ...
  return (
    <Offcanvas
      ...
      <OffcanvasBody className="my-offcanvas-body">
        <FormLayout
          formSlug="tblcontactdirectory"
          editUrl="/edit-contact-directory"
          addUrl="/add-contact-directory"
...
export default AddEditContactDirectory;
