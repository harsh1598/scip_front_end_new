...
import Filter from "./Investor/Filter";
import IRRPortfolioTbl from "./Investor/IRRPortfolioTbl";
import IRRChart from "./Investor/IRRChart";
import GrossIrrTbl from "./Investor/GrossIrrTbl";
import GrossWeightageTbl from "./Investor/GrossWeightageTbl";
import GrossIRRChart from "./Investor/GrossIRRChart";
import GrossMultipleChart from "./Investor/GrossMultipleChart";
            ...
            <Card className=''>
                ...
                <CardHeader className="align-items-center ">
                    <Row className="g-0 align-items-center mb-0">
                        <Col sm={4}>
                            <h4 className="card-title flex-grow-1">Investor</h4>
                        </Col>
