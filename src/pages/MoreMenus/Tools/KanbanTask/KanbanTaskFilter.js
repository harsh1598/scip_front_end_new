...
const KanbanTaskFilter = ({ show, onCloseClick, formData, setFormData }) => {
                    ...
                    <OffcanvasBody >
                        <div>
                            <Row>
                                <Col lg={12}>
                                    <div className="mb-3">
                                        <Label htmlFor="timezone" className="form-label">Priority </Label>
                                        <Select
                                            isClearable={true}
                                            // isMulti
                                            name="priority"
                                            value={formData.priority?formData.priority:[]}
                                            onChange={e=>handleChange("priority", e, 'multi')}
...
export default KanbanTaskFilter;
