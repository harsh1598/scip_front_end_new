...
const CustomSpreadSheetFilter = ({ show, onCloseClick, formData, setFormData }) => {
                ...
                <OffcanvasBody >
                    <div>
                        <Row>
                            <Col lg={12}>
                                <div className="mb-3">
                                    <Label htmlFor="timezone" className="form-label">Company View </Label>
                                    <Select
                                        isClearable={true}
                                        // isMulti
                                        name="companyStage"
...
export default CustomSpreadSheetFilter;
