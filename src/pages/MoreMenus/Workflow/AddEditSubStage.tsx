...
const AddEditSubStage = (props: propData) => {
  ...
  return (
    <Offcanvas
      ...
      <OffcanvasHeader className="bg-light" toggle={props.onCloseClick}>
        {props.formData && props.formData.substageId
          ? "Edit Sub Stage"
          : "Add Sub Stage"}
      </OffcanvasHeader>
      <OffcanvasBody className="my-offcanvas-body">
        <FormLayout
          formSlug="tblsubstage"
          editUrl="/edit-substage"
          addUrl="/add-substage"
          id={props?.formData?.substageId}
          subId={props?.stageId}
...
export default AddEditSubStage;
