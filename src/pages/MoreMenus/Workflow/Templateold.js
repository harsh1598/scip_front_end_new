...
import AddTemplate from "./AddEditTemplate";

const Template = () => {

    document.title = `${ProjectName} | Template`;
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Template" pageTitle="Template" location={"/admin/menu"} />
                    <Row>
                        <Col lg={12}>
                            <Card id="leadsList">
                                        ...
                                        <div className="col-sm-auto ms-auto">
                                            <div className="hstack gap-2 flex-wrap">
                                                ...
                                                <button
                                                    ...
                                                    id="create-btn"
                                                    onClick={e => toggleModel('AddTemplate')}
                                                >
            ...
            <AddTemplate
                show={modelName === 'AddTemplate' ? true : false}
