...
const MoreMenuRubric = () => {
  document.title = `${ProjectName} | Rubric`;
              ...
              <DropdownMenu className="dropdown-menu-end">
                ...
                {data.menueMoadule.sel_action_button && data.menueMoadule.sel_action_button.length > 0 && data.menueMoadule.sel_action_button.map((res: any) => {
                  return (<>
                    ...
                    {
                      res == "Rubric Criteria" && <DropdownItem>
                        <Link
                          className="text-body"
                          id="Team"
                          to={{
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Rubric" pageTitle="Rubric" location={"/admin/menu"} />
          <Row>
            <Col lg={12}>
              <Card id="leadsList">
                      ...
                      <div className="col-sm-auto ms-auto">
                        <div className="hstack gap-2 flex-wrap">
                          <button
                            ...
                            id="create-btn"
                            onClick={(e) => toggleModel("AddRubric")}>
      ...
      <AddRubric
        ...
        show={modelName === "AddRubric" ? true : false}
        onCloseClick={() => {
          setModelName("");
        }}
      />
