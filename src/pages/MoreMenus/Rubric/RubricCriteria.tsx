...
import AddRubricCriteria from "./AddRubricCriteria";
import Grid, {
  GridColumn,
  GridHeader,
  GridRow,
...
const RubricCriteria = () => {
  document.title = `${ProjectName} | Rubric Criteria`;
  ...
  const getlist = (page?: any) => {
    ...
    obj.rubicId = id ? id : "";
    WebService.getAPI({
      action: `/rubric-criteria-pagination-list`,
      body: obj,
    })
      .then((res: any) => {
        if (res && res.coloumns) {
          ...
          <li className="list-inline-item">
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                <DropdownItem
                  onClick={(e) => toggleModel("AddRubricCriteria", data.id)}>
                ...
                <DropdownItem>
                  <Link
                    ...
                    id="Team"
                    to={{
                      pathname: `/admin/rubricCriteria/${data.id}`,
                    }}>
                    <i className="ri-team-line align-middle me-1"></i>Rubric
                    Criteria
                  </Link>
                </DropdownItem>
              </DropdownMenu>
  ...
  return (
    <React.Fragment>
                    ...
                    <div className="col-sm-auto ms-auto">
                      <div className="hstack gap-2 flex-wrap">
                        <button
                          ...
                          id="create-btn"
                          onClick={(e) => toggleModel("AddRubricCriteria")}>
      ...
      <AddRubricCriteria
        ...
        getlist={() => getlist(1)}
        show={modelName === "AddRubricCriteria" ? true : false}
        onCloseClick={() => {
          setModelName("");
        }}
        parentId={id}
