            ...
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                {data.menueMoadule.is_edit == 1 && (
                  <DropdownItem
                    onClick={(e) => toggleModel("AddEditTeam", data.id)}>
                    <i className="ri-edit-box-line align-middle me-1"></i>Edit
                  </DropdownItem>
                )}
                {/* {data.menueMoadule.sel_action_button[0] == 'Active/Inactive'} */}
                        ...
                        {res == "Team member" && (
                          <DropdownItem>
                            <Link
                              ...
                              id="Team"
                              to="/admin/TeamMember">
                              <i className="ri-team-line align-middle me-1"></i>
                              Team Member
                            </Link>
                          </DropdownItem>
                        )}
                      ...
                      <div className="col-sm-auto ms-auto">
                        <div className="hstack gap-2 flex-wrap">
                          <button
                            ...
                            id="create-btn"
                            onClick={(e) => toggleModel("AddEditTeam")}>
