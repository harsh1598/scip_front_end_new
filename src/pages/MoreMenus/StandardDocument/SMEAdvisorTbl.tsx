...
const SMEAdvisorTbl = (props: propData) => {
                        ...
                        <UncontrolledDropdown>
                            ...
                            <DropdownMenu className="dropdown-menu-end">
                                {data.menueMoadule.is_edit == 1 &&
                                    <DropdownItem onClick={e => props.toggleModel('AddEditContactDirectory', data.id)}>
