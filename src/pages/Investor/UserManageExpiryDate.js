...
const UserManageExpiryDate = ({ show, onCloseClick }) => {
                ...
                <OffcanvasBody >
                    <div>
                        <Row>
                            <Col lg={12}>
                                <div className="mb-3">
                                    <Label htmlFor="timezone" className="form-label"> Select Users <span className='text-danger'>*</span>  </Label>
                                    <div>
...
export default UserManageExpiryDate;
