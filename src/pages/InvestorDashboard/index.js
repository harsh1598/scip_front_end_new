...
import InvestorProfileBar from "./InvestorProfileBar";
import InvestorMenuBar from "./InvestorMenuBar";
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Button
            ...
            color="light"
            className={
              screenType === "sm" ? "inner-humburger" : "inner-humburger_size"
            }
          >
