                ...
                <Row>
                    ...
                    <Col lg={12}>
                        <div className="mb-2">
                            ...
                            <div className="input-group">
                                ...
                                <Input type="text" className="form-control" placeholder="50000001" aria-label="Username" aria-describedby="basic-addon1"  disabled
                                validate={{
                                    required: { value: true },
                                }} 
                                />
                    ...
                    <Col lg={12}>
                        <div className="mb-2">
                            ...
                            <div className="input-group">
                                <span className="input-group-text" id="basic-addon1">INR</span>
                                <Input type="text" className="form-control" placeholder="337100000" aria-label="Username" aria-describedby="basic-addon1"  disabled
                                validate={{
                                    required: { value: true },
                                }} 
                                />
