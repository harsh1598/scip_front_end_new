...
const InvestorAssistantDetails = () => {
    const {
        register,
        handleSubmit,
        setValue,
    ...
    const onClickImport = () => {
        var obj: any = {}
        obj.type = 'investor_subuser_details'
        WebService.postAPI({
    ...
    const onSave = (data: any) => {
        if (documentName) {
            WebService.fileUploadAPI({
                action: `/import-investor-sub-user-details-file`,
                key: 'file',
                file: image,
                body: {
    ...
    return (
        <>
            <Common name="Investor Assistant/Nominee Details" setShow={setShow} />
            <Offcanvas
                direction="end"
                isOpen={show}
                id="offcanvasExample"
            ...
            >
                <OffcanvasHeader className="bg-light" toggle={onCloseClick}>
                    Import Investor Assistant/Nominee Details
                </OffcanvasHeader>
...
export default InvestorAssistantDetails;
