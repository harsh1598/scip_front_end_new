...
const SMEAdvisorDetails = () => {
    ...
    const onSave = (data: any) => {
        if (documentName) {
            WebService.fileUploadAPI({
                action: `/import-sme-advisor-details-file`,
                key: 'file',
                file: image,
                body: {
    ...
    return (
        <>
            <Common name="SME Advisor Details" setShow={setShow} />
            <Offcanvas
                direction="end"
                isOpen={show}
                id="offcanvasExample"
...
export default SMEAdvisorDetails;
