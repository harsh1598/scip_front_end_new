...
const InvestorFamilyMemberandCompany = () => {
    const {
        register,
        handleSubmit,
        setValue,
    ...
    const onClickImport = () => {
        var obj: any = {}
        obj.type = 'investor_family_member_company'
        WebService.postAPI({
    ...
    const onSave = (data: any) => {
        if (documentName) {
            WebService.fileUploadAPI({
                action: `/import-investor-family-member-and-company-file`,
                key: 'file',
                file: image,
                body: {
    ...
    return (
        <>
            <Common name="Investor Family Member and Company" setShow={setShow} />
            <Offcanvas
                direction="end"
                isOpen={show}
                id="offcanvasExample"
            ...
            >
                <OffcanvasHeader className="bg-light" toggle={onCloseClick}>
                    Import Investor Family Member and Company
                </OffcanvasHeader>
...
export default InvestorFamilyMemberandCompany;
