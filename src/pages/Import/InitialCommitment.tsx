...
const InitialCommitment = () => {
    ...
    const onSave = (data: any) => {
        // if (documentName) {
            WebService.fileUploadAPI({
                action: `/import-initial-commitment-file`,
                key: 'file',
                // file: image,
                body: {
                    ...
                    initialCommitment: data.initialCommitment,
                    // file: documentName,
                },
            })
                .then((res: any) => {
    ...
    return (
        <>
            <Common name="Initial Commitment" setShow={setShow} />
            <Offcanvas
                direction="end"
                isOpen={show}
                id="offcanvasExample"
                    ...
                    <OffcanvasBody>
                        <Row>
                            ...
                            <Col lg={12}>
                                <div className="mb-2">
                                    <Label htmlFor="name-field" className="form-label">
                                    Initial Commitment <span className="text-danger">*</span>
                                    </Label>
                                    <input
                                        type="number"
                                        className="form-control"
                                        ...
                                        autoComplete="off"
                                        {...register("initialCommitment", {
                                            required: true,
                                        })}
                                    />
                                    <div>
                                        {errors.initialCommitment && (
                                            <span className="text-danger fs-12">Please Enter Initial Commitment</span>
                                        )}
                                    </div>
                                </div>
                            </Col>
