                    ...
                    <Col xl={6}>
                        <Card className="card-height-100">
                            ...
                            <div className="card-body p-0">
                                <div dir='rtl'>
                                    <CountriesCharts series={countryData} dir="ltr" dataColors='["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-secondary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary"]' />
                                </div>
                            </div>
                        </Card>
                    </Col>
