                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium text-dark">Admin Login</p>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            <h5 className="text-brand">Create New Account</h5>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the SCIP 
                                                        <Link to="/" className="text-brand text-decoration-underline fst-normal fw-medium ms-1">Terms of Use</Link></p>
                                                </div>

                                                <div className="mt-4">
                                                    <button className="btn btn-brand-theme w-100" type="submit">Sign Up</button>
                                                </div>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Already have an account ? <Link to="/login" className="fw-semibold text-brand text-decoration-underline"> Signin </Link> </p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
