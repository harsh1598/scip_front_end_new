...
import Calendar from "../../EntrepreneurDashboard/Training/Calendar/index";
    ...
    <React.Fragment>
      <div className=""> {/* page-content */}
        ...
        <div className="mb-none profile-wrapper">
          <Row className="g-0">
            <Col>
              <h3 className="text-white mb-4">Trainings</h3>
            </Col>
          </Row>
        </div>
                  ...
                  <TabPane tabId="1">
                    <div className="profile-timeline">
                      <div className="accordion accordion-flush" id="">
                        {/* <SimpleBar style={{ height: "350px", overflowX: "hidden", }}>*/}
                        <Row className="mb-2">
                          ...
                          <div className="col-lg-10">
                            ...
                            <p className="text-muted fs-13 mb-1">
                              <b>For Whom:</b> Open to all{" "}
                              <i className="mdi mdi-circle-medium align-middle mx-1"></i>{" "}
                              <b>Duration:</b> 16 days over 6 months{" "}
                              <i className="mdi mdi-circle-medium align-middle mx-1"></i>{" "}
                              <b>Start Date:</b> – Nov 13, 2025
                              <b>
                                <i className="mdi mdi-circle-medium align-middle mx-1"></i>{" "}
                                Location:
                              </b>{" "}
