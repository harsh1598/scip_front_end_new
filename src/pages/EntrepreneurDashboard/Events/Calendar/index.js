...
import UpcommingEvents from "../Calendar/UpcommingEvents";
...
const Calender = () => {
  ...
  const TimezoneOptn = [
    ...
    {
      value: "(GMT -11:00) Pacific, Pago Pago",
    ...
    {
      value: "(GMT -09:00) America, Sitka",
      label: "(GMT -09:00) America, Sitka",
    },
    {
      value: "(GMT -08:00) America, Tijuana",
            ...
            <Col xs={12}>
              ...
              >
                <OffcanvasHeader
                  toggle={toggle}
                  tag="h5"
                  className="p-3 modal-title bg-light"
                >
                        ...
                        <Col md={6}>
                          <div className="flex-grow-1 d-flex align-items-start mb=3">
                            ...
                            <div className="flex-grow-1">
                              ...
                              <p className="fs-5">
                                25-Aug-2023 <span className="ms-2">13:00</span>{" "}
                              </p>
                            </div>
                          </div>
                        </Col>
                          ...
                          <div className="flex-grow-1 d-flex align-items-start mb=3">
                            ...
                            <div className="flex-grow-1">
                              ...
                              <p className="fs-5">
                                ...
                                Learn more Images may be subject to copyright.
                                Learn More
                              </p>
                            </div>
                          </div>
                ...
                <div className="offcanvas-foorter border p-3 text-center">
                  <div className="hstack gap-2 justify-content-end">
                    ...
                    <Button toggle={toggle} className="btn btn-light">
                      Cancel
                    </Button>
                  </div>
                </div>
      ...
      >
        ...
        <div className="offcanvas-foorter border p-3 text-center">
          <div className="hstack gap-2 justify-content-end">
            ...
            <Button toggle={toggleUpdtTimeZone} className="btn btn-light">
              Cancel
            </Button>
          </div>
        </div>
