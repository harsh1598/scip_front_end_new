...
const AddTeamMemberModal = ({ show, onCloseClick, modelName, toggleModel }) => {
          ...
          <div className="px-4">
            <Form>
              <Row>
                ...
                <Col lg={12}>
                  <Label className="form-check-label">
                    Member Email <span className="error">*</span>
                  </Label>
                  <Input
                    type="text"
                    className="form-control mb-3"
                ...
                <Col lg={12}>
                  <Label className="form-check-label">
                    Member Phone <span className="error">*</span>
                  </Label>
                  <Input
                    type="text"
                    className="form-control mb-3"
                ...
                <Col lg={12}>
                  <Label className="form-check-label">
                    Member WhatsApp Number <span className="error">*</span>
                  </Label>
                  <Input
                    type="text"
                    className="form-control mb-3"
