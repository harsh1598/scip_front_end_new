                    ...
                    <>
                        <div className="d-flex align-items-center">
                            <div className="flex-grow-1 ms-2 name">
                                <Link to="/kyc_reporting/get_family_member_list" className="fw-medium ">{contact.row.original.name}</Link>
                            </div>
                        </div>
                    </>
                ),
                ...
                Cell: (contact) => (
                    <>
                        <ul className="list-inline hstack gap-1 mb-0">
                            ...
                            {
                                contact.row.original.AadharCard === "Yes" &&
                ...
                Cell: (contact) => (
                    <>
                        <ul className="list-inline hstack gap-1 mb-0">
                            ...
                            {
                                contact.row.original.AddressProof === "Yes" &&
                                <div className="float-end mt-1">
                                    <UncontrolledDropdown direction='end'>
                                        <DropdownToggle tag="a" className="text-reset" role="button"  >
                                            <span className="text-dark fs-16">
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="KYC Documnts" pageTitle="KYC Documnts" location={"/investor"} />
                    <Row>
                        <Col lg={12}>
                            <Card id="leadsList">
                                        ...
                                        <div className="col-sm-auto ms-auto">
                                            <div className="d-flex hstack gap-2 flex-wrap">
                                                <UncontrolledDropdown>
                                                    ...
                                                    >
                                                        <li>
                                                            <DropdownItem onClick={e => toggle('AddKYC')}>
                                                                <i className=" ri-add-fill align-bottom me-1 " ></i> Add KYC
                                                            </DropdownItem>
                                                        </li>
                                                        <li>
                                                            <DropdownItem onClick={e => toggle('EditKYC')}>
                                                                <i className=" ri-pencil-line align-bottom me-1 "></i> Edit KYC
                                                            </DropdownItem>
                                                        </li>
                                                    </DropdownMenu>
                                                </UncontrolledDropdown>
            ...
            />
            <AddKYC
                show={modelName.name == 'AddKYC' ? true : false}
                onCloseClick={() => setModelName("")}
            />
            <EditKYC
                show={modelName.name == 'EditKYC' ? true : false}
                onCloseClick={() => setModelName("")}
            />
        </React.Fragment>
    );
