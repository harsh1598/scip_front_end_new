...
const EcommerceCustomers = () => {
        ...
        return ( <
                ...
                <
                ExportCSVModal show = { isExportCSV }
                onCloseClick = {
                ...
                onCloseClick = {
                    () => setDeleteModal(false) }
                /> <
                DeleteModal show = { deleteModalMulti }
                onDeleteClick = {
                    () => {
                        deleteMultiple();
                ...
                div > {
                    ...
                    toggle = { toggle } > {!!isEdit ? "Edit Customer" : "Add Customer" } <
                    /ModalHeader> <
                                ...
                                /Input> {
                                    validation.touched.status &&
                                        validation.errors.status ? ( <
                                            FormFeedback type = "invalid" > { validation.errors.status } <
                                            /FormFeedback>
                                        ) : null
                                } <
                                /div> <
