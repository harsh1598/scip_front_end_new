                ...
                <TabPane tabId="1">
                  <Form action="#">
                    <Row>
                      ...
                      <Col lg={6}>
                        <div className="mb-3">
                          <Label htmlFor="birthdayidInput" className="form-label">
                            Date of Birth
                          </Label>
                          <Flatpickr
                            className="form-control"
                      ...
                      <Col lg={4}>
                        <div className="mb-3">
                          <Label htmlFor="countryidInput" className="form-label">
                            Country
                          </Label>
                          <Input
                            type="text"
                      ...
                      <Col lg={4}>
                        <div className="mb-3">
                          <Label htmlFor="zipcodeidInput" className="form-label">
                            Zip Code
                          </Label>
                          <Input
                            type="text"
                ...
                <TabPane tabId="2">
                  <form action="#">
                    <Row>
                      ...
                      <Col lg={6}>
                        <div className="mb-3">
                          <Label htmlFor="pancardInput" className="form-label">
                            Pan Card Number
                          </Label>
                          <Input
                            type="text"
                      ...
                      <Col lg={4}>
                        <div className="mb-3">
                          <Label htmlFor="companyemailInput" className="form-label">
                            Email
                          </Label>
                          <Input
                            type="email"
                      ...
                      <Col lg={6}>
                        <div className="mb-3">
                          <Label htmlFor="worknumberInput" className="form-label">
                            Number
                          </Label>
                          <Input
                            type="number"
                      ...
                      <Col lg={6}>
                        <div className="mb-3">
                          <Label htmlFor="companylogoInput" className="form-label">
                            Company Logo
                          </Label>
                          <Input
                            type="file"
