...
const InitialCommitmentLeadInvestor = (props: propData) => {
    const [modelName, setModelName] = useState("");
    const [leadInvestor, setLeadInvestor] = useState<any>()
    ...
    return (
        <>
            <Col className="border-box mb-2">
                <Card style={{ minHeight: !leadInvestor ? '100px' : '89px' }} className={!leadInvestor ? 'small-card-loader card-body mb-0' : 'card-body mb-0'}>
                    {leadInvestor &&
...
export default memo(InitialCommitmentLeadInvestor);
