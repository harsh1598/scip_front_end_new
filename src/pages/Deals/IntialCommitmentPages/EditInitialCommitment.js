...
const EditInitialCommitment = ({ show, onCloseClick }) => {
                                    ...
                                    <div>
                                        <div className="d-flex align-items-start">
                                            ...
                                            >
                                                ...
                                                <span style={{ alignItems: "start", display: "flex" }}>{tagsData.columns.length ? tagsData.columns.length + " Selected" : " Select Self/Family Member/Company"}</span>
                                            </button>
                                        </div>
                                        {
                                            dropdownOpen &&
...
export default EditInitialCommitment;
