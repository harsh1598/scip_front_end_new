              ...
              <Row className="mb-3">
                <Col md={4}>
                  <div className="form-check">
                    ...
                    >
                      Member <i className="ri-information-fill "></i>
                    </Label>
                  </div>
                </Col>
                <Col md={8}>
                ...
                <Col md={6}>
                  <div className="form-check">
                    ...
                    <Label
                      ...
                      htmlFor="auth-remember-check"
                    >
                      Member - Profile <i className="ri-information-fill "></i>
                    </Label>
                  </div>
                </Col>
              </Row>
                    ...
                    <div key={index}>
                      <InputGroup className="mb-2">
                        <Input
                          ...
                          onChange={(e) => handleChange("title", e, index, "t")}
                          required
                        />
                        <Button
                          className="btn-soft-danger mx-1"
                          onClick={() => handleShow("textarea", index)}
                        >
                          <i className="ri-pencil-line" />
                        </Button>
                        <Button
                          className="btn-soft-danger me-1"
                          onClick={() => handleShow("date", index)}
                        >
                          <i className="ri-calendar-todo-line " />
                        </Button>
                        <Button
                          className="btn-soft-danger"
                          onClick={() => handleRemoveClick(index, "t")}
                        >
