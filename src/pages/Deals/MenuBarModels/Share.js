...
import {  Offcanvas, OffcanvasHeader, OffcanvasBody,  Row,  Col, Card, CardBody , Modal , ModalHeader, ModalBody} from "reactstrap";
        ...
        <Offcanvas direction="end" isOpen={show} id="offcanvasExample" toggle={onCloseClick}
            ...
            <form action="" className="d-flex flex-column justify-content-end h-100">
                <OffcanvasBody>
                    <Row>
                        <Col xxl={4} md={6}>
                            <Card className="card-animate bg-warning bg-gradient" onClick={e => toggleModel('Evaluation')} style={{ cursor: "pointer" }}>
                                <CardBody className="p-3 text-center">
                                     <div className="mx-auto avatar-md mb-3">
                                        <img src={deals_under_evaluation} alt="" className="img-fluid" />
                                    </div>
                        ...
                        <Col xxl={4} md={6}>
                            <Card className="card-animate bg-danger bg-gradient" onClick={() => { setIsShow(true); }} style={{ cursor: "pointer" }}>
                                <CardBody className="p-3 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                        ...
                        <Col xxl={4} md={6}>
                            <Card className="card-animate bg-info bg-gradient" onClick={e => toggleModel('InitialCommitment')} style={{ cursor: "pointer" }}>
                                <CardBody className="p-3 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                                        <img src={initial_investment} alt="" className="img-fluid" />
                                    </div>
                        ...
                        <Col xxl={4} md={6}>
                            <Card className="card-animate bg-success bg-gradient" onClick={e => toggleModel('FinalCommitment')} style={{ cursor: "pointer" }}>
                                <CardBody className="p-3 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                        ...
                        <Col xxl={4} md={6}>
                            <Card className="card-animate bg-success bg-gradient" onClick={e => toggleModel('CallForMoney')} style={{ cursor: "pointer" }}>
                                <CardBody className="p-3 text-center">
                                    <div className="mx-auto avatar-md mb-3">
                    ...
                    <Modal id="showModal" isOpen={isShow} toggle={togglePopup} centered>
                        ...
                        <ModalBody>
                            ...
                            <h5><Link to="#" onClick={e => toggleModel('CreateSchedule')}>Click here</Link> to schedule a meeting to open the deal on Web and App in the tile Forthcoming Presentation. </h5>
                        </ModalBody>
                    </Modal>
                </OffcanvasBody>
