...
const FeaturedNFT = () => {
    return (
        <React.Fragment>
            <Row>
                <Col xxl={8}>
                    <div className="d-flex pt-3 mb-n4">
                        <h5 className="card-title fs-18 mb-n1">Featured NFTs Artworks</h5>
                    </div>
                                ...
                                <SwiperSlide key={key}>
                                    <div className="card explore-box card-animate rounded">
                                        ...
                                        <CardBody>
                                            ...
                                            <h5 className="mb-1 clearfix text-truncate fs-16"><Link to="/apps-nft-item-details" className='text-reset'>{item.title}</Link></h5>
