...
import PartialExitFilter from "./PartialExitFilter";
    ...
    return (
        <React.Fragment>
                ...
                <div className="col-sm-auto ms-auto">
                    <div className="hstack gap-2 flex-wrap">
                        <button type="button" className="btn btn-soft-info"
                            onClick={e => toggleModel('PartialExitFilter')} >
            ...
            <PartialExitFilter 
                ...
                show={modelName === 'PartialExitFilter' ? true : false}
