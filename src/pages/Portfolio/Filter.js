                ...
                <OffcanvasBody >
                    <div>
                        <Row>
                            ...
                            <Col lg={12}>
                                <div className="mb-3">
                                    <Label htmlFor="timezone" className="form-label">File</Label>
                                    <Select
                                        isClearable={true}
                                        // isMulti
                                        name="file"
                            ...
                            <Col lg={12}>
                                <div className="mb-3">
                                    <Label htmlFor="timezone" className="form-label">Report Type </Label>
                                    <Select
                                        isClearable={true}
                                        // isMulti
                                        name="reportType"
                            ...
                            <Col lg={12}>
                                <div className="mb-3">
                                    <Label htmlFor="timezone" className="form-label">Report Format </Label>
                                    <Select
                                        isClearable={true}
                                        // isMulti
                                        name="reportFormat"
