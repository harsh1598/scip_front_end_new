...
import ExitTblFilter from "./ExitTblFilter";

const crmcontacts = [
    {
        id: 1,
        name: "Relox Data (Relox Data)",
    ...
    {
        id: 2,
        name: "TOCH (Vogueme Technologies Pvt. Ltd.) ",
    ...
    return (
        <React.Fragment>
                ...
                <div className="col-sm-auto ms-auto">
                    <div className="hstack gap-2 flex-wrap">
                        <button type="button" className="btn btn-soft-info"
                            onClick={e => toggleModel('ExitTblFilter')} >
            ...
            <ExitTblFilter 
                ...
                show={modelName === 'ExitTblFilter' ? true : false}
