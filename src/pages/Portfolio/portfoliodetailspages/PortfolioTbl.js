...
import PortfolioTblFilter from "./PortfolioTblFilter";
...
const crmcontacts = [
    ...
    {
        id: 2,
        name: "Go Colourss (Go Fashion India Limited) ",
        totalinvestment: "20,67,656.96",
        noofround: "2",
        noofinvestors: "12",
    },
    {
        id: 3,
        name: "Yahooo (Selco Pvt Ltd 1)",
        totalinvestment: "47,25,588",
        noofround: "1",
        noofinvestors: "10",
    }
];
    ...
    return (
        <React.Fragment>
                ...
                <div className="col-sm-auto ms-auto">
                    <div className="hstack gap-2 flex-wrap">
                        <button type="button" className="btn btn-soft-info"
                            onClick={e => toggleModel('PortfolioTblFilter')} >
            ...
            <PortfolioTblFilter 
                ...
                show={modelName === 'PortfolioTblFilter' ? true : false}
