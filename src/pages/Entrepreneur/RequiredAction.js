...
const RequiredAction = ({ show, onCloseClick, toggle, ind }) => {
      ...
      <form action="" className="d-flex flex-column justify-content-end h-100">
        <OffcanvasBody>
          <Row>
            <Col lg={12}>
              <div className="mb-3">
                <Label htmlFor="timezone" className="form-label"> Select Required Action <span className='text-danger'>*</span>   </Label>
                <Select
                  isClearable={true}
            ...
            <Col lg={12}>
              <div className="mb-3">
                <Label htmlFor="timezone" className="form-label"> Select Investor <span className='text-danger'>*</span>  </Label>
                <div>
            ...
            <Col lg={12}>
              <div>
                <Label htmlFor="note"
                  className="form-label">Action Comment</Label>
              ...
              <div className="offcanvas-footer text-center hstack gap-2 justify-content-end">
                ...
                <button type="button" className="btn" onClick={e => toggle('RequiredActionHistory', ind, 'preCampaign')} >
                  <i className=" ri-feedback-line  align-bottom" id="history"></i>
                </button>
              </div>
            </Col>
