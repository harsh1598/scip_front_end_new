...
const InvestmentReport2Filter = (props: propData) => {
    const {
        handleSubmit,
        control, 
        formState: { errors },
    ...
    const onClickExport = (data: any) => {
        ...
        setInvestmentReport(data)
        setUserOtp("")
        var obj: any = {}
        obj.type = 'InvestmentReport2'
        WebService.postAPI({
        ...
        if (props.acessMenuData.is_export == 1) {
         if (data && data.companyId) {
            ...
            if (data && data.campaignId) {
                ...
                if (investmentReport && investmentReport.companyId) {
                    obj.companyId = investmentReport.companyId;
                }
                if (investmentReport && investmentReport.campaignId) {
                    obj.campaignId = investmentReport.campaignId;
                }
            }
        }
        WebService.postAPI({
            action: "/report/investment-report-two-excel-url",
            body: obj
        }).then((res: any) => {
            if (res) {
...
export default InvestmentReport2Filter;
