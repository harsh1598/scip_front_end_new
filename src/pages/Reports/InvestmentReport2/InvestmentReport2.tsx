...
import InvestmentReport2Filter from "./InvestmentReport2Filter";

interface propData {
    acessMenu: any
}

const InvestmentReport2 = (props: propData) => {
                                ...
                                <Col lg={4}>
                                    <div className="team-profile-img">
                                        <div className="team-content">
                                            <p className="fs-15 mb-1">Investment Report 2</p>
                                        </div>
                                    </div>
                                </Col>
                                {
...
export default InvestmentReport2;
