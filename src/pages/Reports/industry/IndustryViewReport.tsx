...
import IndustryViewFilter from "./IndustryViewFilter";

interface propData {
    acessMenu: any
};

const IndustryViewReport = (props: propData) => {
                                ...
                                <Col lg={4}>
                                    <div className="team-profile-img">
                                        <div className="team-content">
                                            <p className="fs-15 mb-1">Industry View Report</p>
                                        </div>
                                    </div>
                                </Col>
...
export default IndustryViewReport;
