...
import ReinvestmentFilter from "./ReinvestmentFilter";

interface propData {
    acessMenu:any
};

const ReinvestmentReport = (props:propData) => {
                            ...
                            <Col lg={4}>
                                <div className="team-profile-img ">
                                    <div className="team-content">
                                        <p className="fs-15 mb-1">Re investment Report</p>
                                    </div>
                                </div>
                            </Col>
...
export default ReinvestmentReport;
