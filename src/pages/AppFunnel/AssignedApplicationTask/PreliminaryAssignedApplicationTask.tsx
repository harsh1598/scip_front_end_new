...
const PreliminaryAssignedApplicationTask = () => {

    document.title = `${ProjectName} | App Funnel - Assigned Application Tasks`;
        ...
        WebService.getAPI({
            ...
            .then((res: any) => {
                for (var i in res.result.sub_items) {
                    if (res && res.result && res.result.sub_items[i].code == 'assigned_application_tasks') {
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Assigned Application Tasks" pageTitle="Assigned Application Tasks" />
                    <Row>
                        <Col lg={12}>
                            {/*  id="leadsList" -  CardBody className="pt-0" */}
                            <Card>
                            <CardBody>
                                    ...
                                    <TabContent activeTab={tabId} className="text-muted mt-4">
                                        <TabPane
                                            tabId="entrepreneur_assigned_application_tasks"
                                            id="#entrepreneur_app_funnel">
                                            <Entrepreneur />
                                        </TabPane>
                                        <TabPane
                                            tabId="investor_assigned_application_tasks" id="#investor_app_funnel">
                                            <Investor />
                                        </TabPane>
                                        <TabPane
                                            tabId="sme_advisor_assigned_application_tasks" id="#sme_advisor_app_funnel">
                                            <SME />
                                        </TabPane>
                                    </TabContent>
                                </CardBody>
...
export default PreliminaryAssignedApplicationTask;
