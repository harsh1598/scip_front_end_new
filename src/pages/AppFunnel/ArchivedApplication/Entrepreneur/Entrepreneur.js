...
import { Col, Row, Input, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem, } from "reactstrap";
                                        ...
                                        <DropdownMenu className="dropdown-menu-end">
                                            ...
                                            </DropdownItem>
                                            {
                                                ...
                                                <DropdownItem onClick={e => toggleModel('EditWorkFlow')}>
                                                    <i className="ri-close-circle-line align-middle me-1"></i>Activate user account
                                                </DropdownItem>
                                            }
                                        </DropdownMenu>
                                    </UncontrolledDropdown>
                                ...
                                {/* <li className="list-inline-item">
                                    <UncontrolledDropdown>
...

                                        {
                                            cellProps.row.original.Status === "1" &&
                                            <>
                                                <UncontrolledTooltip placement="bottom" target="Activateuseraccount">
                                                    Activate user account
                                                </UncontrolledTooltip>
                                                <DropdownToggle href="#" className="btn btn-soft-secondary btn-md dropdown me-2" tag="button" id="Activateuseraccount" onClick={e => toggleModel('EditWorkFlow')}>
