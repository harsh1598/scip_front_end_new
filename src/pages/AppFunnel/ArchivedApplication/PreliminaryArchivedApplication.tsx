...
const PreliminaryAssignedApplicationTask = () => {
    ...
    document.title = `${ProjectName} | App Funnel - Archived Applications`;
        ...
        WebService.getAPI({
            ...
            .then((res: any) => {
                for (var i in res.result.sub_items) {
                    if (res && res.result && res.result.sub_items[i].code == 'archived_applications') {
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Archived Applications" pageTitle="Archived Applications" />
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <CardBody>
                                    ...
                                    <TabContent activeTab={tabId} className="text-muted mt-4">
                                        <TabPane
                                            tabId="entrepreneur_archived_applications"
                                            id="#entrepreneur_app_funnel">
                                            <Entrepreneur />
                                        </TabPane>
                                        <TabPane
                                            tabId="investor_archived_applications" id="#investor_app_funnel">
                                            <Investor />
                                        </TabPane>
                                        <TabPane
                                            tabId="sme_advisor_archived_applications" id="#sme_advisor_app_funnel">
                                            <SME />
                                        </TabPane>
                                    </TabContent>
                                </CardBody>
