...
const Investor = () => {
    ...
    const checkedAll = useCallback(() => {
        const checkall = document.getElementById("checkBoxAllInvestor");
    ...
    const columns = useMemo(
        () => [
            {
                Header: <div className="form-check"><input type="checkbox" id="checkBoxAllInvestor" className="form-check-input" onClick={() => checkedAll()} /></div>,
                Cell: (cellProps) => {
