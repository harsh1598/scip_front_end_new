...
const crmcontacts = [
    {
        ...
        StartupName: "zgshsand it would not be wrong to say that the growth of OTT platforms has opened a completely new world for the acto",
                    ...
                    return (
                        <>
                            <div className="flex-grow-1 overflow-hidden" style={{ width: "300px" }}>
                                <p className="text-truncate mb-0">{cellProps.row.original.StartupName}</p>
                            </div>
                        </>
                    )
                },
