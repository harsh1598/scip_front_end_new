                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            <Progress value={15} className="progress animated-progress" />

                                        </div>
                                        <div className="mb-4">
                                            <Progress value={25} color="success" className="progress animated-progress" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress value={50} color="info" className="progress animated-progress" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress value={75} color="warning" className="progress animated-progress" />
                                        </div>
                                        <div>
                                            <Progress value={100} color="danger" className="progress animated-progress" />
                                        </div>
                                    </div>
